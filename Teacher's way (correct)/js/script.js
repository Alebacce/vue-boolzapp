...
var app = new Vue ({
    ...
    methods: {
		/* --------  DISCLAIMER ----------- 
		C'è un bel po' di roba extra, ma ciò che era richiesto dall'esercizio
		è stato rispettato
		------------------------------------*/
		...
		deleteMessage(index) {
			...
			// Resetto selectedMessageIndex per non avere problemi di indici dopo
			// l'eliminazione di un messaggio
			this.selectedMessageIndex = false;
		}
    },
